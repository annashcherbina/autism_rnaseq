...
tdn_sub=2^cleaned_E[,batches$TechRep[batches$Condition=="TDN"]]
asdn_sub=2^cleaned_E[,batches$TechRep[batches$Condition=="ASDN"]]
asddm_sub=2^cleaned_E[,batches$TechRep[batches$Condition=="ASDDM"]]
...
g1=c("ConditionASDDM","ConditionASDDM","ConditionASDN")
g2=c("ConditionASDN","ConditionTDN","ConditionTDN")
for(i in seq(1,3))
{
